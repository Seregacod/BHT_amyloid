...
### В данном репозитории представлены написанные нами скрипты и файлы, полученные в результате работы. Содержание репозитория представлено ниже и перечислено в хронологическом порядке.
